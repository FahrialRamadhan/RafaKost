                    ...
                    <div style="display: flex; align-items: center; gap: 14px;">
                        <div style="width: 44px; height: 44px; background: rgba(255,255,255,0.2); border-radius: 10px; display: flex; align-items: center; justify-content: center;">
                            <svg width="22" height="22" fill="white" viewBox="0 0 24 24">
                                <path d="M3 10.5V19a1 1 0 001 1h16a1 1 0 001-1v-8.5M3 10.5L12 4l9 6.5M3 10.5h18M9 20v-6h6v6"/>
                            </svg>
                        </div>
                        <div>
                            <h1 style="color: #ffffff; font-size: 22px; font-weight: 700; margin: 0; letter-spacing: -0.02em;">Tambah Kamar</h1>
                            <p style="color: rgba(255,255,255,0.7); font-size: 13px; margin: 3px 0 0;">Isi form berikut untuk menambahkan kamar baru</p>
                        </div>
                    </div>
                </div>

                {{-- Form Body --}}
                <form action="{{ route('kamars.store') }}" method="POST" enctype="multipart/form-data" style="padding: 32px;">
                    @csrf
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <div style="position: relative;">
                            ...
                            <input type="text" name="harga" 
                                   placeholder="cth. 650.000 - 700.000"
                                   value="{{ old('harga') }}"
                    ...
                    <div style="margin-bottom: 20px;">
                        ...
                        <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 12px;">
                            <label style="cursor: pointer;">
                                <input type="radio" name="status" value="tersedia" {{ old('status') == 'tersedia' ? 'checked' : '' }} style="display: none;" class="status-radio">
                                <div class="status-card" data-value="tersedia"
                                     style="border: 1.5px solid #cbd5e0; border-radius: 10px; padding: 14px; text-align: center; transition: all 0.2s; background: #f8fafc;">
                    ...
                    <div style="margin-bottom: 28px;">
                        ...
                        <label for="image-upload" style="cursor: pointer;">
                            <div id="upload-area"
                                 style="background: #f8fafc; border: 1.5px dashed #cbd5e0; border-radius: 10px; padding: 28px; text-align: center; transition: all 0.2s;"
                                 onmouseover="this.style.borderColor='#1a7fe8'" onmouseout="this.style.borderColor='#cbd5e0'">
                                <svg width="32" height="32" fill="none" stroke="#1a7fe8" stroke-width="1.5" viewBox="0 0 24 24" style="margin: 0 auto 10px;">
                                    <path d="M4 16l4-4 4 4 4-6 4 6M4 20h16a1 1 0 001-1V5a1 1 0 00-1-1H4a1 1 0 00-1 1v14a1 1 0 001 1z"/>
                                </svg>
                                <p id="upload-text" style="color: #718096; font-size: 14px; margin: 0;">Klik untuk unggah foto</p>
                        ...
                        <input type="file" name="image" id="image-upload" accept="image/*" style="display: none;"
                               onchange="document.getElementById('upload-text').textContent = this.files[0] ? this.files[0].name : 'Klik untuk unggah foto'">
                        @error('image')
                            <p style="color: #e53e3e; font-size: 12px; margin-top: 5px;">{{ $message }}</p>
                        @enderror
                    </div>
